...
public class DependencyBank {
	...
	public DependencyBank() {
		Stream.of(ProjectDependency.values()).forEach(pd -> dependencies.put(pd, new Dependency(pd)));
	}

	public Dependency getDependency(ProjectDependency dependency) {
	 ...
	 *
	 * @see Dependency for the object that handles sub-module dependencies. If no dependency is found for a sub-module,
	 *      ie FreeTypeFont for gwt, an exception is thrown so the user can be notified of incompatability
	 */
	public enum ProjectDependency {
		GDX(new String[] { "com.badlogicgames.gdx:gdx:$gdxVersion" },
				...
				new String[] { "com.badlogic.gdx.backends.gdx_backends_gwt" }, "Core Library for LibGDX"),
		...
		TOOLS(new String[] {}, new String[] { "com.badlogicgames.gdx:gdx-tools:$gdxVersion" }, new String[] {},
		...
		CONTROLLERS(new String[] { "com.badlogicgames.gdx:gdx-controllers:$gdxVersion" },
				...
				new String[] { "com.badlogic.gdx.controllers.controllers-gwt" }, "Controller/Gamepad API"),
		...
		BOX2D(new String[] { "com.badlogicgames.gdx:gdx-box2d:$gdxVersion" },
				...
				new String[] { "com.badlogic.gdx.physics.box2d.box2d-gwt" }, "2D Physics Library"),

		BOX2DLIGHTS(new String[] { "com.badlogicgames.box2dlights:box2dlights:$box2DLightsVersion" }, new String[] {},
				...
				new String[] { "Box2DLights" }, "2D Lighting framework that utilises Box2D"),

		ASHLEY(new String[] { "com.badlogicgames.ashley:ashley:$ashleyVersion" }, new String[] {},
				...
				new String[] { "com.badlogic.ashley_gwt" }, "Lightweight Entity framework"),
