package com.gurella.studio.editor.property.bullet;
	...
	private void buildUi() {
		...
		if (value == null) {
			...
			if (!(value instanceof EmptyCollisionShape)) {
				...
				DefaultMetaModelEditor<BulletCollisionShape> shapeModelEditor = new DefaultMetaModelEditor<>(body, shapeContext);
