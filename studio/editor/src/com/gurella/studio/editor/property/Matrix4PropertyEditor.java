...
public class Matrix4PropertyEditor extends CompositePropertyEditor<Matrix4> {
	...
	private void buildUi() {
		...
		if (value == null) {
			...
			createText(Matrix4.M00);
			createText(Matrix4.M01);
			createText(Matrix4.M02);
			createText(Matrix4.M03);
			createText(Matrix4.M10);
			createText(Matrix4.M11);
			createText(Matrix4.M12);
			createText(Matrix4.M13);
			createText(Matrix4.M20);
			createText(Matrix4.M21);
			createText(Matrix4.M22);
			createText(Matrix4.M23);
			createText(Matrix4.M30);
			createText(Matrix4.M31);
			createText(Matrix4.M32);
			createText(Matrix4.M33);
