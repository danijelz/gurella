...
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.arrowDirection;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractButtonStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractComboStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractExpandableCompositeStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractLabelStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractSectionStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractShellStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractSimpleControlStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractSimpleScrollableStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractSpinnerStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractTabFolderStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractTableStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractTextStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractToolBarStyle;
import static com.gurella.studio.editor.engine.ui.style.SwtWidgetStyle.extractTreeStyle;
...
public class SwtEditorUi implements EditorUi {
	...
	public static Font createSwtFont(Font oldFont, int height, boolean bold, boolean italic) {
		if (oldFont == null) {
			return null;
		}
	...
	@Override
	public <T> T showTitleAreaDialog(EditorTitleAreaDialogProperties dialogProperties) {
	...
	@Override
	public SwtEditorScrolledPageBook createScrolledPageBook(EditorComposite parent) {
		return new SwtEditorScrolledPageBook(cast(parent), SWT.NONE);
	}

	@Override
	public SwtEditorScrolledPageBook createScrolledPageBook(EditorComposite parent, ScrolledPageBookStyle style) {
		return new SwtEditorScrolledPageBook(cast(parent), extractSimpleScrollableStyle(style));
	}
}
