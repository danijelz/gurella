...
public class BitmapFontInspectableContainer extends InspectableContainer<IFile> {
	private ModelEditorContainer<BitmapFontProperties> textureProperties;
	...
	public BitmapFontInspectableContainer(InspectorView parent, IFile target) {
		...
		textureProperties = new ModelEditorContainer<>(getBody(), getEditorContext(), findProperties(target));
