...
public abstract class Try<T> {
	...
	/**
	 * Transform success or pass on failure, taking a Try&lt;U&gt; as the result. Takes an optional type parameter of
	...
	public abstract T getUnchecked(Supplier<String> messageSupplier);
	...
	public static <T> T ignored(TrySupplier<T> supplier, T exceptionalValue) {
		try {
			return supplier.get();
		} catch (Throwable ignored) {
...
class Success<T> extends Try<T> {
	...
	@Override
	public T getUnchecked(Supplier<String> messageSupplier) {
		return value;
	}
