...
public class TestInputComponnent extends ScriptComponent {
	...
	public DropTarget getDropTarget(Array<DragSource> dragSources) {
		return new DropTarget() {
			...
			@Override
			public void dragOut(float screenX, float screenY, @SuppressWarnings("hiding") Array<DragSource> dragSources) {
				System.out.println("dragOut");
			}

			@Override
			public void dragMove(float screenX, float screenY, @SuppressWarnings("hiding") Array<DragSource> dragSources) {
				System.out.println("dragMove2");
			}

			@Override
			public void dragIn(float screenX, float screenY, @SuppressWarnings("hiding") Array<DragSource> dragSources) {
