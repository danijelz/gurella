 ...
 * @author Nathan Sweet
 */
public class OrderedValuesIntMap<V> implements Iterable<OrderedValuesIntMap.Entry<V>> {
	...
	public OrderedValuesIntMap(int initialCapacity, float loadFactor) {
		...
		valueTable = cast(new Object[keyTable.length]);
	}

	/** Creates a new map identical to the specified map. */
	public OrderedValuesIntMap(OrderedValuesIntMap<? extends V> map) {
	...
	public V put(int key, V value) {
		if (key == 0) {
			...
			values.removeValue(oldValue, true);
			values.add(value);
			return oldValue;
		}
	...
	public void putAll(OrderedValuesIntMap<V> map) {
	...
	private void resize(int newSize) {
		...
		valueTable = cast(new Object[newSize + stashCapacity]);
	...
	public boolean equals(Object obj) {
		...
		OrderedValuesIntMap<V> other = cast(obj);
		if (other.size != size) {
			return false;
		}
	...
	static private class MapIterator<V> {
		...
		final OrderedValuesIntMap<V> map;
		int nextIndex, currentIndex;
		boolean valid = true;

		public MapIterator(OrderedValuesIntMap<V> map) {
			this.map = map;
			reset();
		}
	...
	static public class Entries<V> extends MapIterator<V> implements Iterable<Entry<V>>, Iterator<Entry<V>> {
		...
		public Entries(OrderedValuesIntMap<V> map) {
			super(map);
		}
	...
	static public class Values<V> extends MapIterator<V> implements Iterable<V>, Iterator<V> {
		public Values(OrderedValuesIntMap<V> map) {
			super(map);
		}
	...
	static public class Keys extends MapIterator<Object> {
		public Keys(OrderedValuesIntMap map) {
			super(map);
		}
