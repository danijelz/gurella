...
public class JsonObjectPersister<T> implements AssetPersister<T> {
	private final Class<T> expectedType;

	public JsonObjectPersister(Class<T> expectedType) {
		this.expectedType = expectedType;
	}

	@Override
	public void persist(AssetRegistry registry, FileHandle file, T asset) {
