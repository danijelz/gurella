...
/**
 * The PreserveAspectRatio class tells the renderer how to scale and position
 * the SVG document in the current viewport. It is roughly equivalent to the
...
public class PreserveAspectRatio {
	...
	public String toString() {
		return "PreserveAspectRatio [alignment=" + alignment + ", scale=" + scale + "]";
	}
}