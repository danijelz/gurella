...
public enum FeatureTag {
	...
	_case("case", "Case-Sensitive Forms"),
	...
	private static IntMap<FeatureTag> tagMap;

	public final int tag;
	public final String description;

	private FeatureTag(String description) {
		this.tag = SfntTagUtils.tagToInt(name());
		this.description = description;
		getTagMap().put(tag, this);
	}

	private FeatureTag(String name, String description) {
		this.tag = SfntTagUtils.tagToInt(name);
		this.description = description;
		getTagMap().put(tag, this);
	}

	public static IntMap<FeatureTag> getTagMap() {
		if (tagMap == null) {
			tagMap = new IntMap<FeatureTag>();
		}
		return tagMap;
	}
