...
class CffDictEntry {
	...
	public Integer[] getRange() {
		if(value == null) {
			value = operands.size == 0 ? null : new Integer[]{new Integer(operands.get(0).intValue()), new Integer(operands.get(1).intValue())};
		}
		return (Integer[]) value;
	}
	...
	public Boolean getBoolean() {
		if(value == null) {
			value = operands.size == 0 ? null : getInteger() == 0 ? Boolean.FALSE : Boolean.TRUE;
		}
