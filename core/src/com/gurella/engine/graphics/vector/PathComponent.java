...
class PathComponent implements PathConstants, Poolable {
	...
	static PathComponent obtain(PathMesh pathMesh) {
		PathComponent pathComponent = Pools.obtain(PathComponent.class);
	...
	float getStrokeWidth() {
		float strokeWidth = canvas.getStrokeWidth() * 0.5f;
