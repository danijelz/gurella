...
public class StructSpeedTest {
	private static final int testSize = 1000000;
	private static final int iterations = 10;
	private static final int subIterations = testSize / iterations;

	private long tcTime;
	private long tcTotalTime;
	private double tcr;

	private long saTime;
	private long saTotalTime;
	private double sar;
	...
	private void testTcRandom(TestClass[] tc, int index, Vector3 testVec) {
		double r = 0;
	...
	private void testTcLinear(TestClass[] tc, Vector3 testVec) {
		double r = 0;
		long time = System.nanoTime();
	...
	private void testSaRandom(StructArray<TestStruct> sa, int index, Vector3 testVec) {
		double r = 0;
		long time = System.nanoTime();
	...
	private void testSaLinear(StructArray<TestStruct> sa, Vector3 testVec) {
		double r = 0;
		long time = System.nanoTime();
